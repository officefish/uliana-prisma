...
const createSiteStore = () =>
  createStore<IStore>()((set) => ({
    ...
    fairDialogOpen: false,
    setFairDialogOpen: (isOpen : boolean) => set(() => ({fairDialogOpen: isOpen})),
    withdrawOpen: false,
...
export const useSiteStore = () => {
  ...
  return {
    ...
    fairDialogOpen: useStore(api, (state: IStore) => state.fairDialogOpen),
    setFairDialogOpen: useStore(api, (state: IStore) => state.setFairDialogOpen),
